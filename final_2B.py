...
csv_file1 = 'sound_2B.csv'  # Replace with your first CSV file path
df1 = prepare_dataframe(csv_file1)

# Load and prepare other CSV files (JRA video tags)
csv_files = [
    'JRA3-001-2B.csv', 'JRA3-002-2B.csv', 'JRA3-003-2B.csv',
    'JRA3-004-2B.csv', 'JRA3-005-2B.csv', 'JRA3-006-2B.csv', 
    'JRA3-009-2B.csv', 'JRA3-010-2B.csv',  
    'JRA3-011-2B.csv'  # Replace with your other CSV file paths
]

# Define individual tag colors directly
tag_colors = {
    'Σώμα Ερμή': 'red',
    'Κορμός δέντρου': 'green',
    'Πανωφόρι': 'purple',
    'Ερμής αριστερό χέρι': 'blue',
    'Μικρός Διόνυσος': 'yellow',
...
output_file = 'comparison_results_by_tag_color_2B.txt'
