...
csv_file1 = 'sound_1B.csv'  # Replace with your first CSV file path
df1 = prepare_dataframe(csv_file1)

# Load and prepare other CSV files (JRA video tags)
csv_files = [
    'JRA3-001-1B.csv', 'JRA3-002-1B.csv', 'JRA3-003-1B.csv', 
    'JRA3-004-1B.csv', 'JRA3-005-1B.csv', 'JRA3-006-1B.csv', 
    'JRA3-007-1B.csv', 'JRA3-008-1B.csv', 'JRA3-009-1B.csv', 'JRA3-010-1B.csv',  
    'JRA3-011-1B.csv'  # Replace with your other CSV file paths
]
...
output_file = 'comparison_results_by_tag_color_1B.txt'
